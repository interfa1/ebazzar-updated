...
<meta charset="utf-8">
    ...
    <meta name="description" content="E-Bazzar | Login ">

    <title>:: E-Bazzar | Sign-In  ::</title>
    <!-- Favicon-->
    ...
    <div class="container">        
        ...
        <div class="navbar-collapse">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link btn btn-primary btn-round" href="<?php echo base_url('auth/signup');?>">SIGN UP</a>
                </li>
            </ul>
        </div>
    </div>
            ...
            <div class="card-plain">
                ...
                <?php endif; ?>
                        ...
                        <div class="input-group input-lg">
                            <input type="text" class="form-control" placeholder="Enter email or mobile number" name="userid" required>
    ...
    <footer class="footer">
        <div class="container">
            ...
            <div class="copyright">
                ...
                <span>Designed by <a href="#" target="_blank">Interface11</a></span>
            </div>
        </div>
    </footer>
</div>

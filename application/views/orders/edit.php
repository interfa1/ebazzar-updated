        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12">
                ...
                <div class="container">
					...
					<?php endif; ?>
                      <form action="<?php echo base_url('orders/edit/'.$id) ?>" method="post">
                          <h2>Do you really want to confirm ?</h2>
            <input type="submit" class="btn btn-raised btn-primary btn-round waves-effect" name="confirm" value="Confirm">
             <input type="submit" class="btn btn-raised btn-danger btn-round waves-effect" name="reject" value="reject">
				<a href="<?php echo base_url('orders/') ?>" class="btn btn-raised btn-warning btn-round waves-effect">Cancel</a>
				</form>
                    </div>
                </div>
            </div>

    ...
    <div class="block-header">
        ...
        <div class="row">
            <div class="col-lg-7 col-md-6 col-sm-12">
                <h2>Dashboard
                <small class="text-muted">Welcome to E-Bazzar</small>
                </h2>
            </div>
            <div class="col-lg-5 col-md-6 col-sm-12">                
                <ul class="breadcrumb float-md-right">
                    <li class="breadcrumb-item"><a href="<?php echo base_url('admin/index');?>"><i class="zmdi zmdi-home"></i> E-Bazzar</a></li>
            ...
            <ul class="row clearfix list-unstyled m-b-0">
                <?php if(in_array('updateGroup', $user_permission)||
                 ...
                 <li class="col-lg-3 col-md-6 col-sm-12">
                    ...
                    <div class="body">
                        <div class="row">
                            <div class="col-7">
                                <h5 class="m-t-0">Groups</h5>
                            </div>
                            <div class="col-5 text-right">
                        <h2 class=""><?php echo $groups_count - 1;?></h2>
                            </div>
                        </div>
                    </div></a>
                </li>
                ...
                <li class="col-lg-3 col-md-6 col-sm-12">
                    ...
                    <div class="body">
                        <div class="row">
                            ...
                            <div class="col-5 text-right">
                            <h2 class=""><?php echo $users_count - 1;?></h2>
                            </div>
                        </div>
                    </div></a>
                </li>
                ...
                <li class="col-lg-3 col-md-6 col-sm-12">
                  <a href="<?php echo base_url('products/');?>">
                    <div class="body">
                        <div class="row">
                            <div class="col-7">
                                <h5 class="m-t-0">Products</h5>
                              </div>
                            <div class="col-5 text-right">
                         <h2 class=""><?php echo $products_count;?></h2>
                            </div>
                        </div>
                      </div></a>
                </li>
                ...
                <li class="col-lg-3 col-md-6 col-sm-12">
                    ...
                    <div class="body">
                        <div class="row">
                            <div class="col-7">
                                <h5 class="m-t-0">Orders</h5>
                               </div>
                            <div class="col-5 text-right">
                     <h2 class=""><?php echo $orders_count;?></h2>
                             </div>
                        </div>
                          </div></a>
                </li>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <img class="rounded avatar" src="<?php echo base_url();?>assets/images/xs/avatar1.jpg" alt="">
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <img class="rounded avatar" src="<?php echo base_url();?>assets/images/xs/avatar2.jpg" alt="">
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <img class="rounded avatar" src="<?php echo base_url();?>assets/images/xs/avatar10.jpg" alt="">
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <img class="rounded avatar" src="<?php echo base_url();?>assets/images/xs/avatar4.jpg" alt="">
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <img class="rounded avatar" src="<?php echo base_url();?>assets/images/xs/avatar5.jpg" alt="">
                                        </td>
                                        <td>
                                        ...
                                        <td class="hidden-md-down">
                                            <ul class="list-unstyled team-info  margin-0">                                               
                                                ...
                                                <li>
                                                    <img src="<?php echo base_url();?>assets/images/xs/avatar1.jpg" alt="Avatar">
                                                </li>
                                                <li>
                                                    <img src="<?php echo base_url();?>assets/images/xs/avatar2.jpg" alt="Avatar">
                                                </li>                            
                    ...
                    <div class="city-selected body l-salmon">
                        <div class="row">
                            ...
                            <div class="icon col-5">
                                <img src="<?php echo base_url();?>assets/images/weather/summer.svg" alt="">
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="carousel-item text-center active">
                                <div class="col-12">
                                    <ul class="row days-list list-unstyled">
                                        <li class="day col-4">
                                            <p>Monday</p>
                                            <img src="<?php echo base_url();?>assets/images/weather/rain.svg" alt="">
                                        </li>
                                        <li class="day col-4">
                                            <p>Tuesday</p>
                                            <img src="<?php echo base_url();?>assets/images/weather/cloudy.svg" alt="">
                                        </li>
                                        <li class="day col-4">
                                            <p>Wednesday</p>
                                            <img src="<?php echo base_url();?>assets/images/weather/wind.svg" alt="">
                                        </li>
                                    </ul>
                                </div>                                
                            </div>
                            <div class="carousel-item text-center">
                                <div class="col-12">
                                    <ul class="row days-list list-unstyled">
                                        <li class="day col-4">
                                            <p>Thursday</p>
                                            <img src="<?php echo base_url();?>assets/images/weather/sky.svg" alt="">
                                        </li>
                                        <li class="day col-4">
                                            <p>Friday</p>
                                            <img src="<?php echo base_url();?>assets/images/weather/cloudy.svg" alt="">

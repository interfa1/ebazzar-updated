...
<div class="page-loader-wrapper">
    <div class="loader">
        <div class="m-t-30"><img class="zmdi-hc-spin" src="<?php echo base_url();?>assets/images/logo.svg" width="48" height="48" alt="Compass"></div>
        <p>Please wait...</p>
    </div>
</div>
...
<nav class="navbar">
    <div class="col-12">        
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?php echo base_url('admin/index');?>"><img src="<?php echo base_url();?>assets/images/logo.svg" width="30" alt="E-Bazzar"><span class="m-l-10">E-Bazzar</span></a>
        </div>
        ...
        <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="<?php echo base_url('auth/logout');?>" class="mega-menu" data-close="true"><i class="zmdi zmdi-power"></i></a></li>

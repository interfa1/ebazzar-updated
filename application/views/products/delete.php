    ...
    <div class="block-header">
        <div class="row">
            <div class="col-lg-7 col-md-6 col-sm-12">
                <h2>Remove Product
                    <small>confirm deletion of the product record</small>
                </h2>
            </div>
    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12">
				...
				<?php endif; ?>
                <form action="<?php echo base_url('products/delete/'.$id) ?>" method="post">
                    <h2>Do you really want to delete the product record ?</h2>
                    <input type="submit" class="btn btn-raised btn-primary btn-round waves-effect" name="confirm" value="Confirm">
				    <a href="<?php echo base_url('products/') ?>" class="btn btn-raised btn-warning btn-round waves-effect">Cancel</a>
				</form>
                    </div>
                </div>
            </div>

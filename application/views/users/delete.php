    ...
    <div class="block-header">
        <div class="row">
            <div class="col-lg-7 col-md-6 col-sm-12">
                <h2>Remove User
                    <small>confirm deletion of the user record</small>
                </h2>
            </div>
                ...
                <div class="container">
					...
					<?php endif; ?>
                      <form action="<?php echo base_url('users/delete/'.$id) ?>" method="post">
                          <h2>Do you really want to delete the user record ?</h2>
            <input type="submit" class="btn btn-raised btn-primary btn-round waves-effect" name="confirm" value="Confirm">
				<a href="<?php echo base_url('users/') ?>" class="btn btn-raised btn-warning btn-round waves-effect">Cancel</a>
				</form>
                    </div>
                </div>
            </div>

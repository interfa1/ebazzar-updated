    ...
    <div class="block-header">
        <div class="row">
            <div class="col-lg-7 col-md-6 col-sm-12">
                <h2>Update User
                    <small>update / change the user details</small>
                </h2>
            </div>
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12">
                ...
                <div class="container">
					...
					<?php endif; ?>
                        <form class="form-horizontal" id="form_validation" method="POST" action="<?php base_url('users/edit');?>" enctype="multipart/form-data">
                            <div class="row clearfix">
                ...
                <select class="form-control" id="active" name="active">
								 <option value="1" <?php if($user_data['active'] == '1'){ echo "selected='selected'"; }?>>Active</option>
										  <option value="0" <?php if($user_data['active'] == '0'){ echo "selected='selected'"; }?>>Inactive</option>
										</select>
                                    </div>
                                </div>
                ...
                <select class="form-control" id="approved" name="approved">
                    <option value="1" <?php if($user_data['approved'] == '1'){ echo "selected='selected'"; }?>>Approved</option>
										  <option value="0" <?php if($user_data['approved'] == '0'){ echo "selected='selected'"; }?>>Non-approved</option>
										</select>
                                    </div>
                                </div>
                            </div>

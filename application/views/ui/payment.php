...
<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets_ui/css/easy-responsive-tabs.css " />
<script src="<?php echo base_url();?>assets_ui/js/easyResponsiveTabs.js"></script>
<!-- //easy-responsive-tabs --> 
...
<!-- credit-card -->
		<script type="text/javascript" src="<?php echo base_url();?>assets_ui/js/creditly.js"></script>
        <link rel="stylesheet" href="<?php echo base_url();?>assets_ui/css/creditly.css" type="text/css" media="all" />
